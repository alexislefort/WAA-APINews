...
const APP_TITLE = 'News News News ! '
                ...
                <div className="App-content">
                    <div className="center-align">
                        ...
                        <form onSubmit={ this.fetchNews }>
                            <input id="news" placeholder='Input news' type="text" value={ this.state.source } onChange={ this.handleChange } />
    ...
    displayNews = () => {
        ...
        if ( news ) {
            ...
            return news.articles.map(
                article => <NewsCard picture={ article.urlToImage } text={ article.description } title={ article.title } url={ article.url }
                    />
            )
        }
